...
[![Build Status](https://travis-ci.org/wise2ck8s/breeze.svg?branch=v1.10)](https://travis-ci.org/wise2ck8s/breeze)
...
```
curl -L https://raw.githubusercontent.com/wise2ck8s/breeze/v1.10.8/docker-compose.yml -o docker-compose.yml
```
...
![Alt](https://github.com/wise2ck8s/breeze/raw/master/manual/BreezeScreenShots002.png)
